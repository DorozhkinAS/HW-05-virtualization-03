 ## Домашнее задание к занятию 4 «Оркестрация группой Docker контейнеров на примере Docker Compose» - Дорожкин Артем
...
<img width="487" height="110" alt="11" src="https://github.com/user-attachments/assets/0be79bfe-91c4-444f-bc46-3d53f2cef1ef" />

<img width="1192" height="395" alt="запушен" src="https://github.com/user-attachments/assets/6e06f72b-bb0e-423f-b8ec-699c2569d5fa" />

<img width="1672" height="387" alt="image" src="https://github.com/user-attachments/assets/c9133111-2069-45cd-a33e-cdee366aff55" />

https://hub.docker.com/repositories/vechniyvrag
...
<img width="1275" height="346" alt="3 3" src="https://github.com/user-attachments/assets/f5d801f3-1203-40cd-8432-ba4f2bd8ed14" />


Это значит, что Docker на хосте направляет трафик с 127.0.0.1:8080 внутрь контейнера на порт 80. После изменения конфигурации Nginx внутри контейнера было указано \
прослушивание порта 81 вместо 80. В результате возникло несоответствие между: опубликованным Docker-портом контейнера (80/tcp); портом, который должен слушать сервис \
внутри контейнера после изменения конфигурации (81). Именно из-за этого доступ к сервису снаружи через curl http://127.0.0.1:8080 перестал работать корректно. 
